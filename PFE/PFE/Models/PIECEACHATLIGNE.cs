...
namespace PFE.Models
{
    public class PIECEACHATLIGNE
    {
        ...
        public string PLANUMSERIE { get; set; }
        public string PLAISIMPRIMABLE { get; set; }
        public string PLASTYLEISGRAS { get; set; }
        public string PLASTYLEISITALIC { get; set; }
        public string PLASTYLEISIMPPARTIEL { get; set; }
        public string PLASTYLEISSOULIGNE { get; set; }
        ...
        public string PLAISSOUMISESC { get; set; }
    }
}
