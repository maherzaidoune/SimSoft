...
namespace PFE.PageModels
{
    ...
    public class SellBREntPageModel : FreshMvvm.FreshBasePageModel
    {
        ...
        public SellBREntPageModel(IRestServices _restService, IDataServices _dataService, IDialogService _dialogService)
        {
